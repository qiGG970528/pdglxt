    ...
    <div class="mod-config">
        <el-form class="landlordsInfo">
            <el-form-item class="landlordsInfo_title">
                <span>
                    <img src="../../img/icon-landlords.svg" class="landlordsInfo_icon">房东信息
                </span>
        ...
        <!-- 租客房屋列表 -->
        <p style="text-align: center;">我的出租房屋</p>
...
export default {
    data(){
        ...
        return{
            ...
            nation:[],//民族列表
            landlordsInfoNation:"",//房东民族
            landlordsInfoNationValue:"",//房东民族Value
            landlordsInfoSexValue:"",//房东性别Value,
            landlordsInfoBirthday:"",//房东生日
            landlordApartments:[],//房东房屋列表
            renterApartments:[],//租客房屋列表
            dialogFormVisible:false,//编辑模态框
            dataListLoading:false,//房东房屋列表loding
            dataFormRule:{
                name:[
